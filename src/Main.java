...
/**
 * Le principe du programme est de lire un fichier (ici crée en direct) .txt
 * dont les "mots" sont pour l'instant les suivantes:
 * 
 * mot_1: Valeur minimum de l'intervalle horizontal mot_2: Valeur maximum de
 * l'intervalle horizontal mot_3: Valeur minimum de l'intervalle vertical mot_4:
 * Valeur maximum de l'intervalle vertical mot_5: Nombre de parametres (ici 1)
 * mot_6: Valeur minimum de l'intervalle du paramètre mot_7: Valeur maximum de
 * l'intervalle du paramètre
 * 
 * 
 * Pour n>7: Soit P un point tq P(i,j,null,temp) Si n%3=2: Valeur de i Si n%3=0:
 * Valeur de j Si n%3=1: Valeur de temp
 * 
 * Les points de cette liste sont noirs pour être vu sur l'image finale.
 * 
 * L'etape d'apres est le choix pour l'utilisateur du programme qu'il desire
 * executer
 * 
 * On remplit alors une image via les donnees recuperees lors de l'execution de
 * l'interpolateur choisis
 * 
 * 
 * @author Tailheuret
 *
...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		outStream.write(" ");
		outStream.write(String.valueOf(width));
		outStream.write(" ");
		outStream.write(String.valueOf(0));
		outStream.write(" ");
		outStream.write(String.valueOf(height));
		outStream.write(" ");
		outStream.write(String.valueOf(1));
		outStream.write(" ");
		outStream.write(String.valueOf(tempMin));
		outStream.write(" ");
		outStream.write(String.valueOf(tempMax));
		outStream.write(" ");
		...
		int nbParameters = scanner.nextInt();
		int bornInfParam1 = scanner.nextInt();
		int bornSupParam1 = scanner.nextInt();

		while (scanner.hasNext()) {
			Point a = new Point(scanner.nextInt(), scanner.nextInt(), null, scanner.nextInt());
			listPoints.add(a);
		}
		scanner.close();
		...
		// Choix de l'interpolateur a  faire (Vornoi, PlusProche, Marching
		// squares)
